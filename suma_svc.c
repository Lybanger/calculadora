/*
 * Este es el programa servidor que contiene al main principal, aqui se registra el servicio
 */
...
static void
suma_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)//todos los procedimientos soportados por este programa y version
{
	union {
	...
	case NULLPROC://procedimiento nulo (no hace nada)
...
int
main (int argc, char **argv)//main principal
{
